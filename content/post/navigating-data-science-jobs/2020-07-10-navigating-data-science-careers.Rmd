...
<ul>
  ...
  <li>What authorship ambitions do you have?</li>
  <li>What is the extent of your collaboration with the PI, with students, and with research staff?</li>
  <li>How much infrastructure development are you signing up to do? </li>
  <li>What stage of a project will you be working on? Read between the lines closely to estimate the division of your time across data collection, experiment design, data cleaning, grant-writing, and paper-writing.</li>
</ul>
</br>
...
<ul>
  <li> Sean J Taylor, of `prophet` fame, talked to Casual Inference about using causal inference at Lyft. </li>
  <li>Chris Albon - political scientist, and maker of flashcards discussed his approach to hiring at Devoted Health on the Google Cloud Platform Podcast. </li>
  <li>Stephanie Kirmer gave an insightful keynote address at #satRdaysChicago last year about what data science can learn from sociology. </li>
</ul>
...
<p align="justify">
This image never fails to make me laugh, but I really think the answer to this question is **do not gatekeep, comment your code, and learn SQL**". (Highly reluctant note to self - the message to not gatekeep applies to Stata users too.)
...
The important thing though, is that these differences are closing rapidly. We're seeing more instances of R deployed to production, more statistical packages in Python, and `reticulate` to help the two languages play nicely with each other. Whichever you decide is your primary language, I would highly recommend being at least conversant in the other, and be able to read and review code in it.
</p>
